...
Note: Security of the devices is not setup, we will setup that process in the next Guide Named: [Security-Module](https://github.com/watsoninfosec/ELK-SIEM/tree/main/Deployment-Guide/Security-Module)